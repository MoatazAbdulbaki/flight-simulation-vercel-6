...
export function drawSkybox() {
  const front = new THREE.TextureLoader().load("public/textures/front2.bmp");
  const back = new THREE.TextureLoader().load("public/textures/back2.bmp");
  const left = new THREE.TextureLoader().load("public/textures/left2.bmp");
  const right = new THREE.TextureLoader().load("public/textures/right2.bmp");
  const top = new THREE.TextureLoader().load("public/textures/top2.bmp");
  const bottom = new THREE.TextureLoader().load("public/textures/bottom2.bmp");
...
const floor2 = drawFloor(
  ...
  0,
  1000,
  "public/textures/road-texture2.jpeg",
  1,
  400
)
